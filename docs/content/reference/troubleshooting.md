...
Most of these come down to network reality or how cacm serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cacm rate-limits like any public site. cacm already paces
...
Where a surface is gated, cacm reads a cookie or token you supply
...
`cacm`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cacm actually did
